...
<!DOCTYPE HTML>
	<HTML>
		...
		<body style="background-color:lightgrey">
			...
			<img style="border-" src="getimage.php" width="175" height="200" /><br/>
			...
			<font style="text-transform: uppercase;" color="red">id:</font>&nbsp &nbsp<font style="text-transform: uppercase;" > <?php echo $row1['user_id'].$row['last_name'] ?></font><br/>
			...
			<center><dev>
			 <button class="button button_shadow"  onclick="location.href='editprofile.php'" >Edit Profile </button>
 			&nbsp &nbsp<button class="button button_shadow"  onclick="location.href='welcome.php'" >Back</button>
 		</dev> </center>
